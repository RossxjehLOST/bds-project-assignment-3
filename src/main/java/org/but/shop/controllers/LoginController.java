...
import org.but.shop.services.AuthService;
...
public class LoginController {
    ...
    private void initializeServices() {
        ...
        authService = new AuthService(shopRepository);
    }
    ...
    private void showPersonsView() {
        try {
            ...
            fxmlLoader.setLocation(App.class.getResource("fxml/Shop.fxml"));
            Scene scene = new Scene(fxmlLoader.load(), 1050, 600);
            Stage stage = new Stage();
            stage.setTitle("Shop customers database");
    ...
    private void showInvalidPaswordDialog() {
        ...
        alert.setContentText("Your username or password is incorrect");//ww  w . j  a  va2s  .  co  m
    ...
    private void authConfirmDialog() {
        ...
        alert.setHeaderText("Welcome to hell!");
